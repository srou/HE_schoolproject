...
n=5
L=50
filename="second_order_moment"+str(n)+"_2.txt"
f = open(filename, "a")
...
f.write("\n")
f.write("\n")
f.write("Compute Second Order Moment of "+str(list_nb))
f.write("\n")
f.write("\n")
f.flush()
start = time.time()
...
f.write("\n")
f.write("Deviation : "+str(math.fabs(int(decrypted_res[0][0])-sec_order_moment)))
f.write("\n")
